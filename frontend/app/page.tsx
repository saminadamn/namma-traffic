    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 pb-4 flex gap-5 sm:gap-8">
          {[
            ...
            <div key={s.label} className="flex items-center gap-3 sm:gap-4">
              <div>
                <p className="text-base sm:text-xl font-semibold text-gov-900">
                  {s.val}
                </p>
            ...
            <div className="gov-card p-5">
              <div className="flex items-center gap-4 mb-5">
                <div className="w-10 h-10 bg-gov-50 rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg
                    className="w-5 h-5 text-gov-500"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                ...
                >
                  ...
                  <p className="text-xs text-gray-400 mt-0.5">
                    {t("traffic_personnel_desc").split("—")[0].trim()} →
                  </p>
                </Link>
                <Link
          ...
          <>
            ...
            <div className="gov-card p-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                <Link
                  href="/citizen/report"
                  className="gov-card p-3 hover:border-gov-300 hover:shadow-sm transition-all"
                >
                  <p className="text-sm font-medium text-gov-900">
                    {t("nav_report")}
                  </p>
                  <p className="text-xs text-gray-400 mt-0.5">
                    {t("role_citizen_desc").split(",")[0]} →
                  </p>
                </Link>
                <Link
                  href="/citizen/heatmap"
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-400">
                  {t("authority_active_desc")}
                </p>
              </div>
              <span className="gov-btn !py-1.5 !px-3 !text-xs flex-shrink-0">
                {t("btn_dashboard")} →
              </span>
            </Link>
          </>
      ...
      <section className="border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-4 py-8">
          <p className="text-xl font-bold text-gov-900 mb-6">
            {t("faq_title")}
          </p>
          <div className="divide-y divide-gray-100 border border-gray-100 rounded-xl overflow-hidden">
            {faqItems.map((item, idx) => (
              <div key={idx} className="bg-white">
                ...
                >
                  <span className="text-sm font-medium text-gov-900 leading-snug">
                    {item.q}
                  </span>
                  <svg
