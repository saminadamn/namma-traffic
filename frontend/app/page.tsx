        ...
        <div className="max-w-6xl mx-auto px-4 py-10 md:py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              {
                step: "02",
                title: "AI Analyses & Prioritises",
                desc: "Our AI model scores incident severity, detects emerging hotspots, and predicts which roads are at risk — before things get worse.",
                icon: (
                  <svg className="w-5 h-5 text-gov-500" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
