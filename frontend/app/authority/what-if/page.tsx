        ...
        <div className="lg:col-span-2 space-y-3">
          {result ? (
            <>
              <div className="grid grid-cols-2 gap-3">
                <div className="gov-card p-4 border border-red-100 bg-red-50">
                  ...
                  <p className="text-2xl sm:text-3xl font-medium text-red-700">{result.new_congestion_estimate_pct}%</p>
                </div>
                <div className="gov-card p-4">
                  <p className="text-[11px] text-gray-500 mb-1">Traffic increase</p>
                  <p className="text-2xl sm:text-3xl font-medium text-amber-700">+{result.traffic_increase_pct}%</p>
                </div>
              </div>
            ...
            <div className="gov-card p-8 sm:p-10 text-center text-xs text-gray-400">
              Run a what-if scenario to see results
            </div>
          )}
        </div>
      </div>
